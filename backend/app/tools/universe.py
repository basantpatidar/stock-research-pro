...
_TECH = [
    ...
    "ADBE", "CRM", "CSCO", "AMD", "INTC", "QCOM", "TXN", "INTU", "NOW", "IBM",
    "MU", "AMAT", "LRCX", "KLAC", "ADI", "PANW", "SNPS", "CDNS",
]

_FINANCIALS = [
    "JPM", "BAC", "WFC", "C", "GS", "MS", "BLK", "AXP", "USB", "PNC",
    "TFC", "SCHW", "COF", "BX", "KKR", "V", "MA", "PYPL",
]

_HEALTHCARE = [
    "JNJ", "UNH", "LLY", "PFE", "ABBV", "MRK", "TMO", "ABT", "DHR", "BMY",
    "AMGN", "GILD", "ISRG", "CVS", "CI", "ELV", "VRTX",
]

_CONSUMER_DISCRETIONARY = [
    "TSLA", "HD", "NKE", "MCD", "LOW", "SBUX", "TJX", "BKNG", "ABNB",
    "DIS", "GM", "F", "MAR", "EBAY",
]

_CONSUMER_STAPLES = [
    "WMT", "COST", "PG", "KO", "PEP", "PM", "MO", "MDLZ", "TGT", "CL",
    "KMB", "GIS",
]

_INDUSTRIALS = [
    "BA", "CAT", "HON", "LMT", "RTX", "DE", "UNP", "UPS", "FDX", "GE",
    "MMM", "ETN", "EMR", "ITW", "NOC",
]
...
_COMMUNICATION_SERVICES = [
    "NFLX", "T", "VZ", "TMUS", "CMCSA", "DIS", "EA", "TTWO",
]
...
SP500_LIQUID: list[str] = _dedup(
    _TECH, _FINANCIALS, _HEALTHCARE, _CONSUMER_DISCRETIONARY, _CONSUMER_STAPLES,
    _INDUSTRIALS, _ENERGY, _COMMUNICATION_SERVICES, _UTILITIES, _MATERIALS, _REAL_ESTATE,
)
...
MEGA_CAP: list[str] = [
    ...
    "AVGO", "JPM", "LLY", "V", "UNH", "XOM", "MA", "WMT", "JNJ", "PG",
]
...
LEGACY_TOP30 = _dedup(
    _TECH[:15], _FINANCIALS[:6], _HEALTHCARE[:5], _ENERGY[:4],
)
